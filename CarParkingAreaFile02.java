 ...
 * RESULT OF INNOVATION: SIMPLIFYING THE PROGRAM AS FOR THE FORWARD UPDATES WHIT SAMPLE FUNCTIONS.
*/
...
public class CarParkingSystem15 {
    ...
    public static void addRegisteredPlate(Scanner scanner) throws IOException {
        ...
        if (isRegistered(plate)) {
            ...
            numRegisteredPlates++;
             ...
             // Prompt the user for the owner's name and store it in the parkedPlateOwners DOUBLE DIMEN. array.
            System.out.println("Enter the car owner's name:");

            String ownerName = scanner.nextLine(); 
            // OwnerName is just a sample that user can create new line of code to read owner name only if they want.
    ...
    //Method to check if a vehicle with the given plate number is registered of not---> FOR UPCOMING FUNCTIONS.
    ...
    //Method to check if a vehicle with the given plate number is registered of not just---> TO DISPLAY TO THE USER.
...
// Method to check the given vehicle is Parked or not for addParkedPlate and removeParkedPlate functions.
...
// User can also SEARCH BY PLATE uploaded here just for SAMPLE how to add more FUNCTIONS.
...
// q
// Registered plates saved to registered_plates.txt; and is saved in the location of the code
